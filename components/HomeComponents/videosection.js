    ...
    >
      ...
      >
        ...
        <p className="text-white text-lg sm:text-md mt-4 max-w-md">
          ...
          technologically advanced, and fully automated cooker-making machines
          that empower brands with precision, efficiency, and durability. With a
          commitment to innovation and excellence, we deliver industry-leading
          solutions that redefine manufacturing standards.
        </p>
      </motion.div>
    </motion.div>
  );
